...
import com.hiroku.tournaments.api.events.tournament.ForfeitTournamentEvent;
import com.hiroku.tournaments.api.events.tournament.JoinTournamentEvent;
import com.hiroku.tournaments.api.events.tournament.LeaveTournamentEvent;
import com.hiroku.tournaments.api.events.tournament.TeamKnockedOutEvent;
...
public class Tournament extends Mode
{
	...
	private RuleSet ruleSet = new RuleSet(new String[]{});
